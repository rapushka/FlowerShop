...
namespace Flower_shop
{
	public static class DataGridExtensions
	{
		...
		private const int IndexOfColumnOrderId = 4;
		...
		public static int SelectedOrderId(this DataGridView @this)
			=> (int)@this.SelectedRows[0].Cells[IndexOfColumnOrderId].Value;
